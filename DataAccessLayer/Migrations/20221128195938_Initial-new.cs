    ...
    public partial class Initialnew : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_FileViewer", x => new { x.FileDataId, x.UserId });
                    table.ForeignKey(
                        name: "FK_FileViewer_FileData_FileDataId",
                        column: x => x.FileDataId,
                        principalSchema: "dbo",
                        principalTable: "FileData",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_FileViewer_Users_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ShortLink_FileData_AppFileDataId",
                        column: x => x.AppFileDataId,
                        principalSchema: "dbo",
                        principalTable: "FileData",
                        principalColumn: "Id",
