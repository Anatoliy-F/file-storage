    ...
    public class AutoMapperProfile : Profile
    {
        public AutoMapperProfile()
        {
            CreateMap<AppFileData, FileDataModel>()
                ...
                .ForMember(dm => dm.OwnerId, d => d.MapFrom(e => e.AppUserId))
                .ForMember(dm => dm.OwnerName, d => d.MapFrom(e => e.AppUserNav == null ? string.Empty : e.AppUserNav.UserName))
            ...
            CreateMap<QueryOptionsModel, PaginationRequestModel>();
